...
final class ProdutosSeeder extends Seeder
{
    ...
    {
    $stmt = $this->db->prepare('INSERT INTO produtos (menu_id, categoria_id, nome, descricao, preco, tempo_preparo, disponivel, imagem_url) VALUES (:menu_id, :categoria_id, :nome, :descricao, :preco, :tempo, 1, :img)');
        ...
        foreach ($menus as $m) {
            ...
            for ($i = 0; $i < $qtd; $i++) {
                ...
                $stmt->execute([
                    ...
                    ':img' => $this->faker->imageUrl(640, 480, 'food', true, 'produto'),
                ]);
            }
        }
    }
